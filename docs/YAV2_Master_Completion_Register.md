...
- **Status:** **P5 backend schema/RPC foundation — EXECUTED / CLOSED PASS** on V2/yav2-dev (Migration 0021, 2026-07-19). Discovery & design remains CLOSED PASS WITH NOTES. **P5 UI read-only checkpoint CP-4 (read-only Service Applicability section) — CLOSED PASS** (2026-07-20, corrected local runtime verification; commit `f9f2eb3989811c50c32fec65be78f2df41281721`; see P5-UI CP-4 closure record below). **PG-1 backend correction (Migration 0022 — authoritative OTHER-notes enforcement) — EXECUTED / CLOSED PASS** on V2/yav2-dev (2026-07-21; committed `6a96b3d5bd7203daf2c421169ca0261a8435b505`; see P5 PG-1 record below). **CP-5 is now UNBLOCKED for separate authorisation but NOT STARTED; CP-6 NOT STARTED.**
