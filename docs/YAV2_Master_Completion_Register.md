...
- **Sub-phase status:**
  ...
  - **D3 (P3) legacy person backfill: DISCOVERY EXECUTED** (read-only discovery run on V2 2026-07-18; evidence recorded; migration/backfill 0019 remains OPEN / BLOCKED, NOT authored/executable).
