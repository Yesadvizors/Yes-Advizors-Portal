...
- **Status:** **P5 backend schema/RPC foundation — EXECUTED / CLOSED PASS** on V2/yav2-dev (Migration 0021, 2026-07-19). Discovery & design remains CLOSED PASS WITH NOTES. **P5 UI read-only checkpoint CP-4 (read-only Service Applicability section) — CLOSED PASS** (2026-07-20, corrected local runtime verification; commit `f9f2eb3989811c50c32fec65be78f2df41281721`; see P5-UI CP-4 closure record below). **PG-1 backend correction (Migration 0022 — authoritative OTHER-notes enforcement) — AUTHORED / NOT EXECUTED / AWAITING REVIEW** (2026-07-21; see P5 PG-1 record below). **CP-5/CP-6 write UI — NOT STARTED; CP-5 remains BLOCKED until PG-1 is reviewed, manually executed by PJ on V2, and CLOSED PASS.**
...
| 0022 | **P5 PG-1 — OTHER-notes authoritative enforcement (table CHECK `csa_other_notes_required_chk` + create/update RPC guards) — AUTHORED / NOT EXECUTED / AWAITING REVIEW** (2026-07-21) | P5 (PG-1) |
